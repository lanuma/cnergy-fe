    ...
    <div class="content-photo-detail d-flex mt-5">
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
                        <div class="carousel-indicators d-flex align-items-center list-photo-detail">
                            ...
                            <button type="button" data-bs-target="#carouselExampleIndicators"
                                ...
                                aria-current="false" aria-label="Slide {{ ($loop->index)+1 }}">
        ...
        <div class="col-4 vertical-scroll">
            <div class="all-news-info">
                ...
                {{-- Berita terkini --}}
                @include( 'defaultsite.desktop.components-ui.ui-latestphoto', ['latest'=> $row['latest']])
            </div>
            <div style="background: #333333; padding: 30px 10px; text-align:center" class="d-flex flex-column align-items-center gap-5">
                <a href="/">
                ...
                <span style="color: #FFFFFF">Copyright &copy; {{date("Y")}} {{ config('site.attributes.title') }} KLY KapanLagi Youniverse All Rights Reserved </span>
            </div>
        </div>
    </div>
</div>
