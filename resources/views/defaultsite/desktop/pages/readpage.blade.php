                                ...
                                <div class="dt-body-pages">
                                    <div id="pages-intro" class="dt-body-pages-item">
                                        <div class="dt-image mb-6">
                                            <figure class="item">
                                                <span class="item-img rounded-lg {{ !($row['news_image']['real'] ?? null) ? 'aspect-[16/9]' : '' }}">
                                                     @include('image', ['source'=>$row, 'size'=>'640x', $row['news_title']??null])
                                                </span>
                                                <figcaption class="item-desc pt-2">
                                                    <p class="item-desc-copyright text-12 text-gray">{{$row['news_imageinfo']??null}}</p>
                                                </figcaption>
                                            </figure>
                                        </div>
