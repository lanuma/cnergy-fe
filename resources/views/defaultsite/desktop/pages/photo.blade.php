    ...
    <div class="mt-3 photo-headline topFoto">
        <div class="topFoto-item item rounded-3">
            <a href="{{ Src::detail($headline[0]) }}" class="item-img item-img--main"
                data-duration="{{ count($headline[0]['photonews']??0) }}" aria-label="{{$headline[0]['news_title']??null}}">
            ...
            <a href="{{ Src::detail($headline[1]) }}" class="item-img item-img--aside"
                data-duration="{{ count($headline[1]['photonews']??0) }}" aria-label="{{$headline[1]['news_title']??null}}">
            ...
            <a href="{{ Src::detail($headline[2]) }}" class="item-img item-img--aside"
                data-duration="{{ count($headline[2]['photonews']??0) }}" aria-label="{{$headline[2]['news_title']??null}}">
            ...
            <a href="{{ Src::detail($headline[3]) }}" class="item-img item-img--aside"
                data-duration="{{ count($headline[3]['photonews']??0) }}" aria-label="{{$headline[3]['news_title']??null}}">
