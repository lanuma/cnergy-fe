<div class="main-content-news-container">
    ...
    <div class="account-shared-content">
        ...
        <div class="shared">
            <a href="#"><img src="{{ URL::asset('assets/icons/facebook-shared.svg') }}" alt="facebook"></a>
            <a href="#"><img src="{{ URL::asset('assets/icons/twitter-shared.svg') }}" alt="twitter"></a>
    ...
    <div class="content-news mt-3">
        <a href="#">
            <figure>
                ...
                <figcaption>Tersangka kasus pembunuhan Wayan Mirna Salihin, Jessica Kumala Wongso dikawal petugas masuk
                    ke dalam Rutan Pondok Bambu, Jakarta Timur, Jumat (27/5). Jessica terus menunduk saat memasuki
                    gerbang pintu rutan. (Liputan6.com/Yoppy Renato)</figcaption>
            </figure>
        </a>
        <pre>
